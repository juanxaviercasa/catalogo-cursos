...
import { teraboxCabellosalirrosasCatalog, teraboxCabellosalirrosasSecondCatalog, teraboxCatalog } from "../shared/teraboxCatalog";
...
async function loadCatalog(origin: string): Promise<DriveCourse[]> {
  ...
  catalogCache = [...payload.data, ...teraboxCatalog, ...teraboxCabellosalirrosasCatalog, ...teraboxCabellosalirrosasSecondCatalog];
  return catalogCache;
}
