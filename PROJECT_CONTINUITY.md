...
## Segundo enlace Terabox — cabellosalirrosas@gmail.com

Se incorporó el enlace compartido `https://www.1024terabox.com/s/1JA9tWWmNRL1nTHLBWrpqfg`, que el usuario indicó que se gestiona mediante «Iniciar sesión con Google». La página lo muestra como permanentemente válido y expone 20 carpetas: LLC en USA, Courses, Ingles, Maquina del Dinero, Digital Freedom Academy, SEOPlus, Insta To Riches, Master en 6 Cifras, Contable, Duerme Como Tesla, Lanza tu Escuela Online, English for Developers, Libros Mate, Formula 100k, ventas, VSL, YouTube + IA, Víctor Heras, Ian Bernal e Infoproducto.

La colección usa IDs `terabox-cabellosalirrosas-second-*` y comparte únicamente la atribución de cuenta con la primera colección; conserva una URL de origen distinta. Las rutas iniciales son pedagógicas y provisionales: IA para cursos de IA, desarrollo, inglés y recursos; Negocio para emprendimiento, marketing, dinero y ventas; Salud para Duerme Como Tesla; y Contenido para los restantes recursos creativos. La etiqueta de procedencia visible está anonimizada como `Ca***r`, por lo que el correo se conserva como atribución indicada por el usuario, no como dato visible en Terabox.


## Tercer enlace Terabox — jxaviercabellos@gmail.com

Se incorporó el enlace compartido `https://1024terabox.com/s/1ak41wq0adRZ3hfiTtJQwVQ`, que el usuario identificó como perteneciente a `jxaviercabellos@gmail.com` y accesible mediante «Iniciar sesión con Google». Terabox muestra la procedencia anonimizada `Xa***o`, por lo que la cuenta se conserva como atribución indicada por el usuario. La raíz contiene 20 elementos: Cursos, Viral Video Course, 7th Level Communications, Sticky Videos, SEO Webinar Bundle, Instagram Glitch, Viral Content Creator AI Automation, Local Riches, Core 4 Karma, Content Editing, Everyday Productivity, Fund Your Purpose, Topical Maps, Listing Agent Certification, Viral Video Social Media Guide, Ecom Explosive Bootcamp, eCourse Launch Lab, Ecom Creative Powerhouse, Content Emporium y The Last eCom Course.

La colección usa IDs `terabox-jxaviercabellos-*`, un enlace separado y una cuenta distinta de `juanxaviercabellos@gmail.com`, `cabellosalirrosas@gmail.com` y las cuentas Google Drive. Se inspeccionó `Yasin Mammeri – Viral Video Course`: contiene al menos 20 archivos y 950.7 MB, con vídeos `.ts`, recursos PNG de zonas para Shorts/Reels/TikTok y documentos de checklist y edición. La ruta inicial se clasifica como Contenido y Redes, pendiente de organizar módulos adicionales conforme se inspeccionen las demás carpetas. No se descargaron archivos.
